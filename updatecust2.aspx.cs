...
public partial class updatecust2 : System.Web.UI.Page
{
    connect c;
    DataSet ds;
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script>alert('Please!!!Enter Customer-Id First...!!!')</script>");
                txtsearch.Text = "";
            }
            else
            {
