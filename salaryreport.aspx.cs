...
public partial class salaryreport : System.Web.UI.Page
{
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select emp_id from payslip where month='" + ddlistm.SelectedItem.Text + "' and year='" + ddlisty.SelectedItem.Text + "'";
                ds = new DataSet();
                ...
                if (ds.Tables["sal"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/salaryreport2.aspx");
                }
                else
                {
