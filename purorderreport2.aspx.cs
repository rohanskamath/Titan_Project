...
public partial class purorderreport2 : System.Web.UI.Page
{
    connect c;
    DataSet ds;
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select order_no from purchaseorder where month='" + ddlistm.SelectedItem.Text + "' and year='" + ddlisty.SelectedItem.Text + "'";
                ds = new DataSet();
                ...
                if (ds.Tables["pur"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/purorderreport.aspx");
                }
                else
                {
