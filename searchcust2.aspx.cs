...
public partial class searchcust2 : System.Web.UI.Page
{
    connect c;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                {
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script>alert('Customer Information Doesnot Exists...!!!!')</script>");
                    Panel1.Visible = false;
                    txtsearch.Text = "";
                }
            }
