...
<head runat="server">
    <title>PaySlip Print Page</title>
...
<body>
    ...
    <div>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:ImageButton ID="imghome" runat="server" Height="146px" ImageUrl="~/images/hom.jpg"
            OnClick="imghome_Click" Width="165px" /></div>
    </form>
</body>
</html>
