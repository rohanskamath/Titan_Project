<%@ Page Language="C#" MasterPageFile="~/homepage1.master" AutoEventWireup="true" CodeFile="salaryreport.aspx.cs" Inherits="salaryreport" Title="Salary Report Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
            ...
            <td colspan="3" style="height: 81px">
                <span style="font-size: 24pt; color: #ffff99; font-family: Copperplate Gothic Bold">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="text-decoration: underline">
                        EMPLOYEE SALARY REPORT!!</span></span></td>
        </tr>
        <tr>
            <td style="width: 571px; height: 53px">
                <strong><span style="color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    Width="166px" ToolTip="Select Year!!!!">
        ...
        <tr>
            <td style="width: 571px; height: 51px">
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <asp:Button ID="btnview" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                    Font-Size="Medium" OnClick="btnview_Click" Text="View Payslip" Width="128px" CssClass ="btn btn2 btn3" ToolTip="Click Here To View Payslip" /></td>
            <td style="width: 112px; height: 51px">
                <asp:Button ID="btnback"
                    runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium"
                    OnClick="btnback_Click" Text="BACK" Width="103px" CssClass ="btn btn2 btn3" ToolTip="Click Here To Go Home!!!" /></td>
