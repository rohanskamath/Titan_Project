...
public partial class serviceadd2 : System.Web.UI.Page
{
    connect c;
    DataSet ds;
    ...
    protected void btncheck_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                txtbdate.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[1]);
                txtname.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[3]);
                txtcustid.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[2]);
                txtphone.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[5]);
                txtmail.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[4]);
                txtadrs.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[6]);
                txtcity.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[7]);
                txtpin.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[8]);
                txtstate.Text = Convert.ToString(ds.Tables["b"].Rows[0].ItemArray[9]);
            }
            else
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script>alert('Sorryy!!Sales Bill Doesnot Exists..!!!!')</script>");
                txtbno.Text = "";
                txtbno.Focus();
            }
    ...
    protected void btnnext_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/service2.aspx");
    }
    ...
    {
        if (txtbdate.Text == "" || txtadrs.Text == "" || txtbno.Text == "" || txtbrand.Text == "" || txtcharge.Text == "" || ddlists.SelectedIndex == 0)
        {
