...
public partial class salesbill : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtphone.Text == "" || txtname.Text == "" || txtadrs.Text == "" || txtcity.Text == "" || txtmail.Text == "" || txtcat.Text == "" ||txtqty .Text =="")
            {
    ...
    protected void btncal_Click(object sender, EventArgs e)
    {
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script>alert('Enter Discount Only Positive Value..!!!')</script>");
        }
        else if (txtdis.Text == "")
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script>alert('Enter Value / If No Discount Enter Zero..!!!')</script>");
        }
        else
        {
    ...
    protected void btnbill_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                c.cmd.Parameters.Add("@bill_no", SqlDbType.NVarChar).Value = txtbillno.Text;
                c.cmd.Parameters.Add("@bill_date", SqlDbType.NVarChar).Value = DateTime.Now.ToShortDateString();
    ...
    protected void nxtpur_Click(object sender, EventArgs e)
    {
