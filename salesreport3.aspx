<%@ Page Language="C#" MasterPageFile="~/homepage2.master" AutoEventWireup="true" CodeFile="salesreport3.aspx.cs" Inherits="salesreport3" Title="Sales Report Page" %>
    ...
    <table>
        <tr>
            <td colspan="3" style="height: 81px">
                <span style="font-size: 24pt; color: #ffff99; font-family: Copperplate Gothic Bold">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="text-decoration: underline">SALES<span>
                        REPORT!!</span></span></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 713px; height: 36px">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="btnview" runat="server" CssClass="btn btn2 btn3"
                    Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" OnClick="btnview_Click"
                    Text="View Saled Products" Width="193px" ToolTip="Click Here For View Report!!" /></td>
            <td style="width: 102px; height: 36px">
                <asp:Button ID="btnback" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                    ...
                    Width="103px" ToolTip="Click here To Go Home!!!" /></td>
