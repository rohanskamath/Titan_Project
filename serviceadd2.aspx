<%@ Page Language="C#" MasterPageFile="~/homepage2.master" AutoEventWireup="true" CodeFile="serviceadd2.aspx.cs" Inherits="serviceadd2" Title="Service Page" %>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </strong><span style="font-size: 24pt"><strong>
                        <span style="color: #ffffff">*******</span>WORLD OF TITAN</strong><span style="color: #ffffff"><strong>*******<br />
                            ...
                            &nbsp;&nbsp; </strong><span style="font-size: 12pt"><strong>C.P.C PLAZA,MAIN ROAD<br />
                                ...
                                </strong><span style="color: #ffff99; font-family: Copperplate Gothic Bold">TAX INVOICE</span></span></span></span></span></span></span></td>
        </tr>
    </table>
    <br />
    <hr />
        ...
        <tr>
            ...
            <td style="width: 260px; height: 32px">
                ...
                <asp:Button ID="btnnew" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                    OnClick="btnnew_Click" Text="NEW" ToolTip="Click Here For ServiceBill Number!!!" /></td>
        ...
        <tr>
            <td colspan="4" style="height: 74px">
                <span style="color: #ffffff"><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; CUSTOMER-TYPE :&nbsp; </strong>
                </span>
                <asp:DropDownList ID="ddlistc" runat="server" AutoPostBack="True" Enabled="False"
                    OnSelectedIndexChanged="ddlistc_SelectedIndexChanged" Width="172px">
            ...
            <table>
                <tr>
                    <td colspan="4" style="height: 49px">
                        ...
                        <asp:TextBox ID="txtbno" runat="server" Font-Bold="False" OnTextChanged="txtbno_TextChanged"
                            ToolTip="Enter Customer Bill No!!!" Width="150px"></asp:TextBox>
                        <asp:Button ID="btncheck" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                            Font-Size="Small" OnClick="btncheck_Click" Text="CHECK" ToolTip="Click Here To Check Bill No!!!"
                            Visible="False" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <tr style="font-family: Times New Roman">
                    ...
                    <td style="width: 308px; height: 47px">
                        <asp:DropDownList ID="ddlistp" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            OnSelectedIndexChanged="ddlistp_SelectedIndexChanged" ToolTip="Select Product-id!!!"
                            Width="184px">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 157px; height: 47px">
                ...
                <tr style="font-family: Times New Roman">
                    <td style="width: 415px; height: 46px">
                        <strong><span style="font-size: 16pt; color: #ffff99"><span style="font-size: 12pt;
                            color: #ffffff"><span style="font-size: 16pt; color: #ffff99">&nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>CATEGORY :</span></span></strong></td>
                    <td style="font-size: 12pt; width: 308px; color: #ffff99; height: 46px">
                        <asp:TextBox ID="txtcat" runat="server" ReadOnly="True" Width="180px"></asp:TextBox></td>
                    <td style="font-size: 12pt; width: 157px; color: #ffff99; height: 46px">
                        <span style="color: #ffffff"><strong>QUANTITY :</strong></span></td>
                    <td style="font-size: 12pt; width: 89px; color: #ffff99; font-family: Copperplate Gothic Bold;
                        height: 46px">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 275px; height: 51px">
                        <asp:DropDownList ID="ddlists" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlists_SelectedIndexChanged"
                            ToolTip="Select Service Type!!!" Width="182px">
                            <asp:ListItem>-----Select-----</asp:ListItem>
                ...
                <tr>
                    <td colspan="4" style="height: 53px">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="btncal" runat="server" Font-Bold="True"
                            Font-Names="Times New Roman" Font-Size="Small" OnClick="btncal_Click" Text="CALCULATE"
                            ToolTip="Click Here To Calculate!!!" Visible="False" Width="127px" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="height: 85px">
                        <strong><span style="color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp;&nbsp; GRAND TOTAL : &nbsp; &nbsp;
                            <asp:TextBox ID="txtgtotal" runat="server" Enabled="False">0</asp:TextBox></span></strong></td>
                </tr>
                <tr>
                    <td colspan="4" style="height: 76px">
                        ...
                        <asp:Button ID="btnsave" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                            ...
                            Text="SHOW BILL" ToolTip="Click Here To Show Bill!!!" Width="124px" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                        &nbsp; &nbsp;&nbsp;
                        <asp:Button ID="btnnext" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                            Font-Names="Times New Roman" Font-Size="Medium" Height="40px" OnClick="btnnext_Click"
                            Text="PRINT BILL" ToolTip="Click here To Print Bill!!!" Width="124px" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button
                            ID="btncancel" runat="server" CssClass="btn btn2 btn3" Font-Bold="True" Font-Names="Times New Roman"
                            Font-Size="Medium" Height="40px" OnClick="btncancel_Click" Text="CANCEL" ToolTip="Click Here To Clear"
                            Width="124px" /></td>
                </tr>
            </table>
        </asp:View>
            ...
            <table>
                ...
                <tr>
                    <td style="width: 415px; height: 47px">
                        <span style="color: #ffffff"><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            &nbsp;NAME :</strong></span></td>
                    <td style="width: 308px; height: 47px">
                        <asp:TextBox ID="txtname2" runat="server" OnTextChanged="txtname2_TextChanged" Width="180px"></asp:TextBox></td>
                    <td style="width: 157px; height: 47px">
                        <strong><span style="color: #ffffff">ADDRESS :</span></strong></td>
                    <td style="width: 89px; height: 47px">
                ...
                <tr>
                    <td style="width: 415px; height: 46px">
                        <strong><span style="color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            ID :</span></strong></td>
                    <td style="width: 308px; height: 46px">
                        <asp:TextBox ID="txtcustid2" runat="server" Enabled="False" Width="180px"></asp:TextBox></td>
                    <td style="width: 157px; height: 46px">
                        <strong><span style="color: #ffffff">CITY :</span></strong></td>
                    <td style="width: 89px; height: 46px">
                        <asp:TextBox ID="txtcity2" runat="server" OnTextChanged="txtcity2_TextChanged" Width="180px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 415px; height: 46px">
                        <strong><span style="color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    <td style="width: 308px; height: 46px">
                        <asp:TextBox ID="txtphone2" runat="server" MaxLength="10" Width="180px"></asp:TextBox></td>
                    <td style="width: 157px; height: 46px">
                    ...
                    <td style="width: 89px; height: 46px">
                        <asp:TextBox ID="txtpin2" runat="server" MaxLength="6" Width="180px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 415px; height: 41px">
                        <strong><span style="color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    <td style="width: 157px; height: 41px">
                        <strong><span style="color: #ffffff">STATE :</span></strong></td>
                    <td style="width: 89px; height: 41px">
                        <asp:TextBox ID="txtstate2" runat="server" OnTextChanged="txtstate2_TextChanged"
                ...
                <tr style="font-family: Times New Roman">
                    ...
                    <td style="width: 157px; height: 47px">
                        <strong><span style="color: #ffffff">BRAND NAME:</span></strong></td>
                    <td style="width: 89px; height: 47px">
                        <asp:TextBox ID="txtbrand2" runat="server" OnTextChanged="txtbrand2_TextChanged"
                            Width="180px"></asp:TextBox></td>
                </tr>
                <tr style="font-family: Times New Roman">
                    <td style="width: 415px; height: 56px">
                        <span style="font-size: 16pt; color: #ffff99"><strong><span style="font-size: 12pt;
                            color: #ffffff">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; PRODUCT TYPE :</span></strong></span></td>
                    <td style="font-size: 12pt; width: 308px; color: #ffff99; height: 56px">
                        <asp:TextBox ID="txttype2" runat="server" Enabled="False" ReadOnly="True" Width="180px"></asp:TextBox></td>
                    <td style="font-size: 12pt; width: 157px; color: #ffff99; height: 56px">
                        <strong><span style="color: #ffffff">MODEL NUMBER :</span></strong></td>
                    <td style="font-size: 12pt; width: 89px; height: 56px">
                        <asp:TextBox ID="txtmodel2" runat="server" Enabled="False" ReadOnly="True" Width="180px"></asp:TextBox></td>
                </tr>
                <tr style="font-size: 12pt; font-family: Times New Roman">
                    <td style="width: 415px; height: 46px">
                        <strong><span style="color: #ffff99"><span style="color: #ffffff"><span style="color: #ffffff">
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;</span>CATEGORY :</span></span></strong></td>
                    <td style="font-size: 12pt; width: 308px; color: #ffff99; height: 46px">
                        <asp:TextBox ID="txtcat2" runat="server" OnTextChanged="txtcat2_TextChanged" Width="180px"></asp:TextBox></td>
                    <td style="font-size: 12pt; width: 157px; color: #ffff99; height: 46px">
                        <span style="color: #ffffff"><strong>QUANTITY :</strong></span></td>
                    <td style="font-size: 12pt; width: 89px; color: #ffff99; font-family: Copperplate Gothic Bold;
                        height: 46px">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 283px; height: 49px">
                        <asp:DropDownList ID="ddlists2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlists2_SelectedIndexChanged"
                            Width="184px">
                            <asp:ListItem>-----Select-----</asp:ListItem>
                            <asp:ListItem>Free</asp:ListItem>
                            <asp:ListItem>Paid</asp:ListItem>
                ...
                <tr>
                    <td colspan="4" style="height: 37px">
                        ...
                        <asp:Button ID="btncal2" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                            OnClick="btncal2_Click" Text="CALCULATE" Visible="False" Width="118px" /></td>
                </tr>
                <tr>
                    <td colspan="4">
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <tr>
                    <td colspan="4">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                        <asp:Button ID="btnshow" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                            Font-Names="Times New Roman" Font-Size="Medium" Height="41px" OnClick="btnshow_Click"
                            Text="SHOW BILL" Width="136px" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                        <asp:Button ID="btnprint" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                            Font-Names="Times New Roman" Font-Size="Medium" Height="41px" OnClick="btnprint_Click"
                            Text="PRINT BILL" Width="131px" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        <asp:Button ID="btnclear" runat="server" CssClass="btn btn2 btn3" Font-Bold="True"
                            Font-Names="Times New Roman" Font-Size="Medium" Height="40px" OnClick="btnclear_Click"
                            Text="CANCEL" Width="126px" /></td>
                </tr>
            </table>
        </asp:View>
        &nbsp;
